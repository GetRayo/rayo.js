...
Dies ist ein **Framework** für das **moderne** Web; klein, glatt, elegant und schnell.<br />
Wir haben `Rayo` entwickelt, nachdem wir zu viel Zeit verbrachten um zu überlegen wie wir die Probleme, die wir mit anderen Frameworks hatten, beheben konnten.
Wir brauchten etwas das ein fast _kompleter_ Ersatz war für das womit die meisten unserer Systeme aufgebaut waren, ohne dabei die Produktivität oder Leistung zu beeinträchtigen.<br />

```
Dein Server wird sich wie vom Blitz getroffen fühlen...
```
