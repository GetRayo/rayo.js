...
Este es un **framework** para la web **moderna**; pequeño, sagaz, elegante y rápido.<br />
Desarrollamos `Rayo` después de pasar mucho tiempo pensando en como solucionar los problemas que encontrábamos con otros frameworks.
Necesitamos algo que puediera ser un remplazo, casi en su _totalidad_, para aquello sobre lo cual la mayoría de nuestros sistemas estaba construidos, sin sacrificar productividad ni rendimiento.<br />

```
Tu servidor sentirá que fue golpeado por un relámpago...
```
